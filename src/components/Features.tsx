...
const Features = () => {
  ...
  return <section className="py-8 sm:py-12 bg-white lg:py-[50px]">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-6xl mx-auto">
          {features.map((feature, index) => <div key={index} className="bg-white p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100 relative">
              ...
              <div className="text-2xl sm:text-3xl lg:text-4xl mb-3 sm:mb-4 text-center">
                {feature.icon === 'truck' ? <Truck className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 mx-auto text-green-600" /> : feature.icon}
              </div>
