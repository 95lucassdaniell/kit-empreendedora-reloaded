        ...
        <div className="max-w-6xl mx-auto">
          ...
          loop: true
            ...
            <CarouselContent className="-ml-4">
              {videoTestimonials.map((video, index) => <CarouselItem key={index} className="pl-4 basis-full md:basis-1/2 lg:basis-1/2">
                  <VideoPlayer videoId={video.videoId} thumbnailUrl={video.thumbnailUrl} title={video.title} author={video.author} location={video.location} />
                </CarouselItem>)}
            </CarouselContent>
